...
from models.unet.mask2mask import Mask2MaskGray
...
if __name__ == "__main__":
    ...
    # )
    main_model = Unet(backbone_name="resnet152", n_classes=1)
    model = Mask2MaskGray(main_model=main_model)
    filename = "/root/dacon/models/ckpt/resunet_mask2mask/resunet_mask2mask_dice_bce_addgray_171_07-26-05:27_0.871699591477712"

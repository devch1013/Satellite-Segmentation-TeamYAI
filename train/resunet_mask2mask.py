...
if __name__ == "__main__":
    ...
    # model = Mask2Mask(main_model)
    ###

    ###
    filename = "/root/dacon/models/ckpt/resunet_mask2mask/resunet_mask2mask_dice_bce_28_07-26-01:52_0.8511921217044195"
    state_dict = torch.load(filename, map_location=device)
